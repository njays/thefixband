...
"We are a 5-8-piece band comprising some of the best UK musicians who have been playing together for many years. <br>Our line up is as follows:<br>" +
...
function contentSetlist() {
	...
	document.getElementById("content").innerHTML =	
                ...
                "<div class='u-flex section-text-setlist'>" +
                "<ul class='section-text__setlist-list u-padding-left u-padding-right'>" +
 ...
 "</ul>" +
                ...
                "<ul class='section-text__setlist-list u-padding-right'>" +
                        ...
                        "<li class='section-text__setlist-listitem'>HOLD MY HAND<br><b>Jess Glynne</b></li>" +
                        "<li class='section-text__setlist-listitem'>DOMINO<br><b>Jessie J</b></li>" +
                        "<li class='section-text__setlist-listitem'>PROMISES<br><b>Calvin Harris</b></li>" +
                        "<li class='section-text__setlist-listitem'>CAN'T FEEL MY FACE<br><b>The Weeknd</b></li>" +
                        "<li class='section-text__setlist-listitem'>SHAPE OF YOU<br><b>Ed Sheeran</b></li>" +
                        "<li class='section-text__setlist-listitem'>ROCKABEYE<br> <b>Clean Bandit</b></li>" +
                        "<li class='section-text__setlist-listitem'>WE ARE YOUNG<br><b>Fun</b></li>" +
                ...
                "<ul class='section-text__setlist-list u-padding-right'>" +
                        ...
                        "<li class='section-text__setlist-listitem'>CAKE BY THE OCEAN<br><b>DNCE</b></li>" +
                        "<li class='section-text__setlist-listitem'>CAN'T STOP THE FEELING<br><b>Justin Timberlake</b></li>" +
                        "<li class='section-text__setlist-listitem'>GET LUCKY<br><b>Daft Punk</b></li>" +
                        "<li class='section-text__setlist-listitem'>SEXUAL<br><b>NAKED</b></li>" +
                        "<li class='section-text__setlist-listitem'>SOMETHING JUST LIKE THIS<br><b>The Chainsmokers</b></li>" +
                        "<li class='section-text__setlist-listitem'>YOUNGBLOOD<br><b>5 Seconds of Summer</b></li>" +
                        "<li class='section-text__setlist-listitem'>NEW RULES<br><b>Dua Lipa</b></li>" +
                    "</ul>" +
                "</div>" +
